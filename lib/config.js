...
function loadHealthchecks() {
  const healthchecks = [];
  if (process.env.HEALTCHECK_1) {
    healthchecks.push(parseHealthcheckEnvVar(process.env.HEALTCHECK_1));
  }
  if (process.env.HEALTCHECK_2) {
    healthchecks.push(parseHealthcheckEnvVar(process.env.HEALTCHECK_2));
  }
  if (process.env.HEALTCHECK_3) {
    healthchecks.push(parseHealthcheckEnvVar(process.env.HEALTCHECK_3));
  }
  return healthchecks;
}
